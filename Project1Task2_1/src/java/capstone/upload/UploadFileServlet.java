...
import capstone.etl.ETLProcessFiles;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                String tableNames = formFields.get("tables");
                
               // siteName = formFields.get("site");
               // model = formFields.get("model");
               // sensor = formFields.get("sensor");
                siteName = tableNames.split("_")[1];
                model = tableNames.split("_")[2];
                sensor = tableNames.split("_")[3];
               
               System.out.println(sensor + " " + siteName + " " + model);
                ...
                processFiles = new ETLProcessFiles();
                ...
                message = "Your upload was successful. Select below to make another upload.";
                nextView = "UploadHomePage.jsp";
            } catch (Exception ex) {
                message = "Your upload was not successful. Try again.";
                nextView = "UploadHomePage.jsp";
            }
        } else {
