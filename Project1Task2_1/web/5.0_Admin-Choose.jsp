...
<html>
    ...
    <body>
        ...
        <div class="w3-container w3-white" >
            <h1 style="color: #533678;"> Admin choices</h1>
        </div>
        ...
        <div class="w3-container">
         <form id="form" action="AdminSelectionServer" method="POST" style="margin-left: 0.25cm">   
            <input TYPE="radio" NAME="queryType" VALUE="createUser" CHECKED>
            Create user id & password
            <BR><BR>
            <input TYPE="radio" NAME="queryType" VALUE="addPerms">
            Add Permissions
            <BR><BR>
            <input TYPE="radio" NAME="queryType" VALUE="deletePerms">
            Delete Permissions
            <BR><BR>
        </div>
        
        <input style = "margin-bottom: 1cm;margin-left: 0.5cm; width: 3cm;" 
