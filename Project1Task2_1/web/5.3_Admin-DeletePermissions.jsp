...
<html>
    ...
    <body>
        ...
        <div class="w3-container w3-white" >
            <h1 style="color: #533678;"> Delete permissions</h1>
        </div>

        <div class="w3-container">
            <h2 style= "height: 2cm; line-height: 1cm; color: #533678;">  ${message} </h2>
            <p>Enter information below to delete permissions to a certain user:</p>
        </div>
        
        <div class="w3-container">
        <form style="margin-left: 0.5cm;" action ="DeletePermissions" method ="POST">                    
        ...
        <label for="letter">Administrator Password: </label>
            <input type="text" name="adminPassword" value="" /><br><br><br>      
        <label for="letter">Username to be deleted: </label>
            <input type="text" name="deletedUser" value="" /><br><br><br>      
        <input style = "margin-bottom: 1cm; width: 3cm;" 
                   type="submit" class="w3-btn w3-blue-grey w3-center" name="button" value="Delete User" />
        </div>
