...
<html>
    ...
    <body>
        ...
        <form style="margin-left: 0.5cm;" action ="LoginServlet" method ="POST">   
            <% String  value = request.getParameter("page"); %>
            <input type="hidden" name="nextPage" value="${value}" />     
        ...
        <input style = "margin-bottom: 1cm; width: 3cm;" 
                   type="submit" class="w3-btn w3-blue-grey w3-center" name="button" value="Login" />             
        </form>                
