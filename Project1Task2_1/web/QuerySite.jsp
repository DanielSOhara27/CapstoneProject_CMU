<%-- 
    Document   : QuerySite(Horizontal join) 
...
<%
    ...
    ResultSet resultset = statement.executeQuery("SELECT distinct `SiteID` FROM `MappingTable`");
...
<html>
    ...
    <body>
        ...
        <form action="QuerySiteSensorType.jsp" method="GET" style = "margin-left: 0.25cm">    
            <div class="w3-row-padding">
                ...
                <TABLE class="w3-table w3-striped w3-bordered w3-border" BORDER="1" style = "width:auto;">
                    ...
                    <tr>
                        <td align="center"><input type="radio" name="site" value="<%= resultset.getString(1)%>"></td>
                    ...
                    <br><input type="submit" class="w3-btn w3-blue-grey w3-center" name="submit" value="Submit">
        </form>
              </div>      
