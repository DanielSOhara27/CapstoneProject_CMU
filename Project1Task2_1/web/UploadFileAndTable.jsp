...
<%
    ...
    ResultSet resultset = statement.executeQuery("SELECT `SensorType`,`TableName`,`SiteID`,`ModelID`,`SensorID`,`Username` FROM `MappingTable` where username='"+uName+"'");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form style="margin-left: 0.5cm;margin-right: 2 cm" action ="UploadFileServlet" method ="POST" enctype="multipart/form-data">  
            ...
            <TABLE class="w3-table w3-striped w3-bordered w3-border" BORDER="1" style = "width:auto; margin-right: 2 cm">
                    <tr>
                        <td>Choose</td>
                        <td>SensorType</td>
                        <td>TableName</td>
